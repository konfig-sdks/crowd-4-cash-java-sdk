...
public class Portfolio {
  public static final String SERIALIZED_NAME_INVESTOR_ACCOUNT = "investorAccount";
  @SerializedName(SERIALIZED_NAME_INVESTOR_ACCOUNT)
  ...
  public Portfolio investorAccount(InvestorAccount investorAccount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.investorAccount, portfolio.investorAccount) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(investorAccount, investments, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    investorAccount: ").append(toIndentedString(investorAccount)).append("\n");
  ...
  static {
    ...
    openapiFields.add("investorAccount");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      // validate the optional field `investorAccount`
      if (jsonObj.get("investorAccount") != null && !jsonObj.get("investorAccount").isJsonNull()) {
        InvestorAccount.validateJsonObject(jsonObj.getAsJsonObject("investorAccount"));
      }
      if (jsonObj.get("investments") != null && !jsonObj.get("investments").isJsonNull()) {
        ...
        if (jsonArrayinvestments != null) {
          ...
          for (int i = 0; i < jsonArrayinvestments.size(); i++) {
            Investment.validateJsonObject(jsonArrayinvestments.get(i).getAsJsonObject());
          };
        }
      }
  }
