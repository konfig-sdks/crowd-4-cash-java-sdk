 ...
 * Your loan agreement
 */
@ApiModel(description = "Your loan agreement")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Contract {
  ...
  public Contract loanId(Integer loanId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "ID of the loan you have invested in")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the file (.PDF)")
  ...
  public Contract contractFile(String contractFile) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "String representation of the contract that is encoded with base-64 digits")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.loanId, contract.loanId) &&
        Objects.equals(this.contractName, contract.contractName) &&
        Objects.equals(this.contractFile, contract.contractFile)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(loanId, contractName, contractFile, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("contractName").isJsonNull() && (jsonObj.get("contractName") != null && !jsonObj.get("contractName").isJsonNull()) && !jsonObj.get("contractName").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("contractFile").isJsonNull() && (jsonObj.get("contractFile") != null && !jsonObj.get("contractFile").isJsonNull()) && !jsonObj.get("contractFile").isJsonPrimitive()) {
