 ...
 * Loan entity
 */
@ApiModel(description = "Loan entity")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Loan {
  ...
  **/
  ...
  public Loan dateCreated(String dateCreated) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "04.06.2019", value = "Date of applicaton")
  ...
  public Loan dateApproved(String dateApproved) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "12.06.2019", value = "Date of approval")
  ...
  **/
  ...
  public Loan lastPaymentDate(String lastPaymentDate) {
  ...
  **/
  ...
  public Loan paymentFrequency(String paymentFrequency) {
  ...
  **/
  ...
  public Loan duration(Integer duration) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "60", value = "Duration in months")
  ...
  public Loan borrowerType(String borrowerType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SME", value = "Type of the borrower - Private or SME")
  ...
  public Loan biddingType(String biddingType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SME Loan", value = "Type of the loan - Private or SME")
  ...
  **/
  ...
  public Loan loanPurpose(String loanPurpose) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Expansion", value = "Purpose of the loan")
  ...
  public Loan loanRating(String loanRating) {
  ...
  **/
  ...
  public Loan loanStatus(String loanStatus) {
  ...
  **/
  ...
  public Loan performanceStatus(String performanceStatus) {
  ...
  **/
  ...
  public Loan daysLate(Integer daysLate) {
  ...
  **/
  ...
  public Loan collateral(String collateral) {
  ...
  **/
  ...
  public Loan collateralType(String collateralType) {
  ...
  **/
  ...
  public Loan insurance(String insurance) {
  ...
  **/
  ...
  public Loan totalPrincipalRemaining(Double totalPrincipalRemaining) {
  ...
  **/
  ...
  public Loan totalRepaidPrincipal(Double totalRepaidPrincipal) {
  ...
  **/
  ...
  public Loan totalRepaidInterest(Double totalRepaidInterest) {
  ...
  **/
  ...
  public Loan biddingEnd(String biddingEnd) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "17.06.2019", value = "End date of the project")
  ...
  public Loan disbursementDate(OffsetDateTime disbursementDate) {
  ...
  **/
  ...
  public Loan maturityDate(OffsetDateTime maturityDate) {
  ...
  **/
  ...
  public Loan bids(List<ActiveBid> bids) {
  ...
  public Loan addBidsItem(ActiveBid bidsItem) {
    if (this.bids == null) {
  ...
  **/
  ...
  public Loan borrowerPrivate(ModelPrivate borrowerPrivate) {
  ...
  **/
  ...
  public Loan borrowerCompany(Company borrowerCompany) {
  ...
  **/
  ...
  public Loan income(Income income) {
  ...
  **/
  ...
  public Loan expenses(Expenses expenses) {
  ...
  **/
  ...
  public Loan questionnaire(Questionnaire questionnaire) {
  ...
  **/
  ...
  public Loan financial(Financial financial) {
  ...
  **/
  ...
  public Loan amortizationSchedule(AmortizationSchedule amortizationSchedule) {
  ...
  **/
  ...
  public Loan accountStatement(AccountStatement accountStatement) {
  ...
  **/
  ...
  public Loan technicalData(TechnicalData technicalData) {
  ...
  **/
   ...
   * @return the Loan instance itself
   */
  public Loan putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, loan.id) &&
        Objects.equals(this.dateCreated, loan.dateCreated) &&
        Objects.equals(this.dateApproved, loan.dateApproved) &&
        Objects.equals(this.loanAmount, loan.loanAmount) &&
        Objects.equals(this.lastPaymentDate, loan.lastPaymentDate) &&
        Objects.equals(this.interestRate, loan.interestRate) &&
        Objects.equals(this.paymentFrequency, loan.paymentFrequency) &&
        Objects.equals(this.duration, loan.duration) &&
        Objects.equals(this.borrowerType, loan.borrowerType) &&
        Objects.equals(this.biddingType, loan.biddingType) &&
        Objects.equals(this.loanType, loan.loanType) &&
        Objects.equals(this.loanPurpose, loan.loanPurpose) &&
        Objects.equals(this.loanRating, loan.loanRating) &&
        Objects.equals(this.loanStatus, loan.loanStatus) &&
        Objects.equals(this.performanceStatus, loan.performanceStatus) &&
        Objects.equals(this.daysLate, loan.daysLate) &&
        Objects.equals(this.collateral, loan.collateral) &&
        Objects.equals(this.collateralType, loan.collateralType) &&
        Objects.equals(this.insurance, loan.insurance) &&
        Objects.equals(this.totalPrincipalRemaining, loan.totalPrincipalRemaining) &&
        Objects.equals(this.totalRepaidPrincipal, loan.totalRepaidPrincipal) &&
        Objects.equals(this.totalRepaidInterest, loan.totalRepaidInterest) &&
        Objects.equals(this.biddingEnd, loan.biddingEnd) &&
        Objects.equals(this.disbursementDate, loan.disbursementDate) &&
        Objects.equals(this.maturityDate, loan.maturityDate) &&
        Objects.equals(this.notes, loan.notes) &&
        Objects.equals(this.link, loan.link) &&
        Objects.equals(this.bids, loan.bids) &&
        Objects.equals(this.borrowerPrivate, loan.borrowerPrivate) &&
        Objects.equals(this.borrowerCompany, loan.borrowerCompany) &&
        Objects.equals(this.income, loan.income) &&
        Objects.equals(this.expenses, loan.expenses) &&
        Objects.equals(this.crif, loan.crif) &&
        Objects.equals(this.questionnaire, loan.questionnaire) &&
        Objects.equals(this.financial, loan.financial) &&
        Objects.equals(this.amortizationSchedule, loan.amortizationSchedule) &&
        Objects.equals(this.accountStatement, loan.accountStatement) &&
        Objects.equals(this.technicalData, loan.technicalData)&&
        Objects.equals(this.additionalProperties, loan.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Loan.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Loan>() {
           ...
           public Loan read(JsonReader in) throws IOException {
             ...
             Loan instance = thisAdapter.fromJsonTree(jsonObj);
