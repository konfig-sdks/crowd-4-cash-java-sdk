...
import com.konfigthis.client.model.AccountStatementEntry;
 ...
 */
@ApiModel(description = "Information about the payment of the instalments by the borrower")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AccountStatement {
  public static final String SERIALIZED_NAME_ENTRIES = "entries";
  @SerializedName(SERIALIZED_NAME_ENTRIES)
  private List<AccountStatementEntry> entries = null;

  public AccountStatement() {
  }

  public AccountStatement entries(List<AccountStatementEntry> entries) {
  ...
  public AccountStatement addEntriesItem(AccountStatementEntry entriesItem) {
  ...
  **/
  ...
  public void setEntries(List<AccountStatementEntry> entries) {
   ...
   * @return the AccountStatement instance itself
   */
  public AccountStatement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entries, accountStatement.entries)&&
        Objects.equals(this.additionalProperties, accountStatement.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountStatement
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountStatement.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("entries") != null && !jsonObj.get("entries").isJsonNull()) {
        ...
        if (jsonArrayentries != null) {
          ...
          for (int i = 0; i < jsonArrayentries.size(); i++) {
            AccountStatementEntry.validateJsonObject(jsonArrayentries.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AccountStatement>() {
           ...
           public AccountStatement read(JsonReader in) throws IOException {
             ...
             AccountStatement instance = thisAdapter.fromJsonTree(jsonObj);
