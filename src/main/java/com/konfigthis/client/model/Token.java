...
public class Token {
  ...
  **/
  ...
  @ApiModelProperty(example = "{token}", value = "C4C Token")
  ...
  public Token expiryDate(OffsetDateTime expiryDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "By when you can use the token")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, token.value) &&
        Objects.equals(this.expiryDate, token.expiryDate)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(value, expiryDate, additionalProperties);
  }
